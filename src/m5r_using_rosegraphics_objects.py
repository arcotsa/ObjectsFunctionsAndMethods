...
#                radius, thickness, self
#
#     f. What does a RoseWindow RENDER method do?
#            allows the objects to be displayed on the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            when you need to observe piece by piece what is happening within the window
#
